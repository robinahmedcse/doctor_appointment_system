...
<link href="{{asset('public/backEnds/')}}/vendors/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <script src="{{asset('public/backEnds/')}}/validation/master_result_control.js"></script>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            @include('supper_admin.include.menu_profile')
            <!-- /menu profile quick info -->
            ...
            <!-- /sidebar menu -->
            <!-- /menu footer buttons -->
            @include('supper_admin.include.menu_footer_buttom')
            <!-- /menu footer buttons -->
          </div>
        </div>
        <!-- top navigation -->
        @include('supper_admin.include.top_nav')
        <!-- /top navigation -->
        <!-- page content -->
        @yield('x')
        <!-- /page content -->
