...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="{{asset('public/asset/backEnds/')}}/vendors/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="{{asset('public/asset/backEnds/')}}/vendors/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->
    <link href="{{asset('public/asset/backEnds/')}}/vendors/nprogress/nprogress.css" rel="stylesheet">
    <!-- iCheck -->
    <link href="{{asset('public/asset/backEnds/')}}/vendors/iCheck/skins/flat/green.css" rel="stylesheet">
	
    <!-- bootstrap-progressbar -->
    <link href="{{asset('public/asset/backEnds/')}}/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- JQVMap -->
    <link href="{{asset('public/asset/backEnds/')}}/vendors/jqvmap/dist/jqvmap.min.css" rel="stylesheet"/>
    <!-- bootstrap-daterangepicker -->
    <link href="{{asset('public/asset/backEnds/')}}/vendors/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">

    <!-- Custom Theme Style -->
    <link href="{{asset('public/asset/backEnds/')}}/build/css/custom.min.css" rel="stylesheet">
  </head>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            @include('patient.include.menu_profile')
            <!-- /menu profile quick info -->

            <br />

            <!-- sidebar menu -->
            @include('patient.include.sidebar')
            <!-- /sidebar menu -->
            <!-- /menu footer buttons -->
            @include('patient.include.menu_footer_buttom')
            <!-- /menu footer buttons -->
          </div>
        </div>
        <!-- top navigation -->
        @include('patient.include.top_nav')
        <!-- /top navigation -->
        <!-- page content -->
        @yield('x')
        <!-- /page content -->
        <!-- footer content -->
        @include('patient.include.footer')
        <!-- /footer content -->
      </div>
    </div>
